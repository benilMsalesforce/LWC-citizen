...
import template from "./extendedStep.html"
...
export default class ExtendedStep extends OmniscriptBaseMixin(AggregatesValidation(omniscriptStep)) {
    _showBack = false;
    _showNext = false;
    showmodal = false;
    ...
    connectedCallback() {
        ...
        this.jsonDef.indexInParent == 0? (this._showBack = false, this._showNext = true):this.jsonDef.propSetMap.isLastStep? (this._showBack = true, this._showNext = false):(this._showBack = true, this._showNext = true)
